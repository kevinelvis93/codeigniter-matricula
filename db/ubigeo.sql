...
CREATE TABLE IF NOT EXISTS `ccp_ubigeo_peru_departments` (
...
CREATE TABLE IF NOT EXISTS `ccp_ubigeo_peru_districts` (
...
CREATE TABLE IF NOT EXISTS `ccp_ubigeo_peru_provinces` (

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-02-2025 a las 05:50:39
...
(19, 16, 'fdurand255@gmail.com', 1),
(55, 12, 'fdurand@gmail.com', 1),
(56, 12, 'fdurand252@gmail.com', 1),
(57, 8, 'amelgarejo@gmail.com', 1),
(58, 19, 'jmaguino@gmail.com', 1),
(59, 18, 'fdurand12453@gmail.com', 1),
(60, 18, 'fdurand12453hj@gmail.com', 1),
(61, 7, 'lcarlos@gmail.com', 1),
(62, 7, 'lcarlos01@gmail.com', 1),
(115, 6, 'pedrocorreo@gmail.com', 1),
(116, 5, 'mario@gmail.com', 1),
(117, 5, 'mario1@gmail.com', 1),
(118, 5, 'mario112345@gmail.com', 1),
(119, 5, 'mario112345453453@gmail.com', 1),
(121, 23, 'fdurand563254@gmail.com', 1),
(137, 25, 'c.fernandez@example.com', 1),
(138, 26, 'prieto@gmail.com', 1),
(152, 1, 'melomedinakevin@gmail.com', 1),
(157, 27, 'pedrob@gmail.com', 1),
(158, 27, 'pedrob01@gmail.com', 1),
(159, 2, 'jose@gmail.com', 1),
(164, 24, 'juan@gmail.com', 1);
...
CREATE TABLE `ccp_persona` (
  ...
  `provincia` varchar(45) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `distrito` varchar(45) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
INSERT INTO `ccp_persona` (`id`, `nombres`, `apellido_paterno`, `apellido_materno`, `departamento`, `provincia`, `distrito`, `direccion`, `estado`) VALUES
(1, 'Kevin Elvis', 'Melo', 'Medina', '15', '1501', '150111', 'Pueblo libre 02', 1),
(2, 'Jose Luis', 'Melo', 'Medina', '15', '1501', '', 'Miraflores', 1),
(5, 'Mario', 'Melo', 'Melo 2', NULL, NULL, NULL, 'El Agustino 3', 1),
(6, 'Pedro', 'Matilde', 'Campos', NULL, NULL, NULL, 'Miraflores', 1),
(7, 'leonel carlos', 'Melo', 'sfsdfbd', NULL, NULL, NULL, 'Lince', 1),
(8, 'Abel', 'Melgarejo', 'Vargas', NULL, NULL, NULL, 'Pueblo Libre 555', 1),
(12, 'FELIPE', 'DURAND', 'GONZALES', NULL, NULL, NULL, '', 1),
(16, 'FELIPE', 'DURAND', 'GONZALES', NULL, NULL, NULL, 'El Agustino', 1),
(17, 'MARIO', 'MELO', 'MELO 2', NULL, NULL, NULL, '', 1),
(18, 'MARIANO', 'SANTOS', 'GONZALES', NULL, NULL, NULL, 'El Agustino', 1),
(19, 'JUAN CARLOS', 'MAGUIÑO', 'TECHÉRA', NULL, NULL, NULL, 'Miraflores', 1),
(20, 'MARIO', 'MELOSDFVSDV', 'SDVSDVSDVS', NULL, NULL, NULL, 'Miraflores', 1),
(23, 'FELIPE', 'MELO', 'SFSDFBD', NULL, NULL, NULL, 'Pueblo Libre 50', 1),
(24, 'JUAN', 'ALCANTARA', 'BELLIDO', '15', '1501', '150118', 'Barranca asociacion', 1),
(25, 'CARLOS ALBERTO', 'FERNÁNDEZ', 'GÓMEZ', NULL, NULL, NULL, 'Av. Los Próceres 456, Lima', 1),
(26, 'LUIS', 'PRIETO', 'CAZORLA', '15', '1501', '150118', 'Av. Proceres ', 1),
(27, 'PEDRO', 'BENITEZ', 'GRIMALDO', '01', '0101', '010116', '', 1);
...
--
-- Estructura de tabla para la tabla `ccp_ubigeo_peru_departments`
--

CREATE TABLE `ccp_ubigeo_peru_departments` (
  `id` varchar(2) NOT NULL,
  `name` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `ccp_ubigeo_peru_departments`
--

INSERT INTO `ccp_ubigeo_peru_departments` (`id`, `name`) VALUES
('01', 'Amazonas'),
('02', 'Áncash'),
('03', 'Apurímac'),
('04', 'Arequipa'),
...
--
-- Estructura de tabla para la tabla `ccp_ubigeo_peru_districts`
--

CREATE TABLE `ccp_ubigeo_peru_districts` (
...
--
-- Volcado de datos para la tabla `ccp_ubigeo_peru_districts`
--

INSERT INTO `ccp_ubigeo_peru_districts` (`id`, `name`, `province_id`, `department_id`) VALUES
...
--
-- Estructura de tabla para la tabla `ccp_ubigeo_peru_provinces`
--

CREATE TABLE `ccp_ubigeo_peru_provinces` (
...
--
-- Volcado de datos para la tabla `ccp_ubigeo_peru_provinces`
--

INSERT INTO `ccp_ubigeo_peru_provinces` (`id`, `name`, `department_id`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
(1, 1, 'kevmelom', '$2y$10$inhuRp7e3tKoXChdb7Ekhen9RF8bvKAFw5NLpO2iFQuBqW7WxLClu', 1),
(2, 2, 'josmelom', '$2y$10$S7iZGJMbNB9vN4KA3YjRvObaOgOpnJ/lNYETr2Qc/0rRM/ua8rUoS', 1),
(4, 5, 'marmelom', '$2y$10$yalH4C2p8U.EWlwpvswcBeUSnOPSdHKh4Mdv.J9XZh90J.a/upjC2', 1),
(5, 6, 'pedmatildec', '$2y$10$NbQ2EdOhU/q3Rbh3U9CQyu0HCqfAqtto7bXOngl5Ol3FgXQUL2b0i', 1),
(6, 7, 'leomelos', '$2y$10$Gtjrs/BzLZWxLYeVw9r6Y.bEgHMULFAORT0iMfQuAtkbj2Lvg1/E.', 1),
(7, 8, 'abemelgarejov', '$2y$10$JT8LYTkI1Gbh1EvB9xXZKeNozViSuX0mEiqu0r6r6gt.4PvEZhvRi', 1),
(11, 12, 'feldurandg', '$2y$10$nA0q0xwxvsrzkcwMDRWcg.TQSwbmt4qVAsl1bcdwxMtFHAk89Z1/y', 1),
(15, 16, '', '$2y$10$axtmDCsgotq/bZQ9d4jp6uVh843YeHR4zhfcc62MTGIkHPKEGH8su', 0),
...
(22, 23, 'felmelos', '$2y$10$A1oXJ.FKrEP0zrAHdPHCXOfLv1muHw.FygbYUi0hbfTQuu.J7RZtK', 1),
(23, 24, 'juaalcantarab', '$2y$10$.HoKZzt80Mu0GxCpqg/4uuHnMqCkqEcWrremtHU8wkTlCcq.KSFmi', 1),
(24, 25, 'carfernandezg', '$2y$10$hyx/kZgMJAi1p0fbEcRSROu/RSkRKrYgbX0gmvYKOlsxgYD43irKy', 1),
(25, 26, 'luiprietoc', '$2y$10$NAyLDF5dOzLJrXa4T5r6SO6WI02pEIfMozT6wscEcui6vQF4gzT3S', 1),
(26, 27, 'pedbenitezg', '$2y$10$y8/Mr0b8IYQ7feheDTVeguXlLT.X8CBnLlcupDxeNy2LGTdAdujgW', 1);
...
--
-- Indices de la tabla `ccp_ubigeo_peru_departments`
--
ALTER TABLE `ccp_ubigeo_peru_departments`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ccp_ubigeo_peru_districts`
--
ALTER TABLE `ccp_ubigeo_peru_districts`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ccp_ubigeo_peru_provinces`
--
ALTER TABLE `ccp_ubigeo_peru_provinces`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `ccp_persona_identificacion`
  MODIFY `id_persona_identificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
